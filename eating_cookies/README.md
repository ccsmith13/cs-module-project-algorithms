...
To run the tests separately, run `python3 test_eating_cookies.py -k small` in order to run jsut the small input test. Run `python3 test_eating_cookies.py -k large` to execute just the large input test. If you want to run both tests, just run `python3 test_eating_cookies.py`.
